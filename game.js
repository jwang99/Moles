...
atom.currentMoleTime = 5;
atom.tillNewMole = 0.6;
var counter = 0;
...
game.timer = function (argument) {
  ...
  if (count<=0){
    ...
    var restart = confirm("Time's Up. Do you wish to restart?") 
    if (restart){
      location.reload(); 
    }
  }
   ...
   atom.context.beginPath();
    ...
    atom.context.fillText("Time left: " + counter, 20,20);
  }
};
